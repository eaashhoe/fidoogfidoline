...
export default function Kontaktos() {
    return (
        <><section className="kontaktheader">
            <div className="heroopdeling">
                <h1>Kom i <span className="herosectionspan"> kontakt</span> med os </h1>
                <p>Er du interesseret i at samarbejde med os eller høre mere om, hvad vi kan gøre for dig.
            ...
            <section className="kontaktsection">
                ...
                <div className="formfieldkontakt">
                    <MyForm />
                </div>
